      ...
      <div className="container relative z-10 py-12">
        ...
        <div className="border-t mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-white/70">
            Copyrights © {currentYear} YISE Brand. All rights reserved.
          </p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a href="#" className="text-sm text-white/70 hover:text-yellow-400">Privacy Policy</a>
            <a href="#" className="text-sm text-white/70 hover:text-yellow-400">Terms of Service</a>
            <a href="#" className="text-sm text-white/70 hover:text-yellow-400">Cookies</a>
          </div>
        </div>
      </div>
    </footer>
